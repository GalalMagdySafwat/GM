...
public class MainActivity extends AppCompatActivity implements LoaderCallbacks<List<Movie>> {
    ...
    private static final int Movie_LOADER_F = 1;
    private static final int Movie_LOADER_S = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loaderManager.initLoader(Movie_LOADER_F,null,SortByPopular);
        }else {

            loaderManager.initLoader(Movie_LOADER_S,null,SortByUserRating);
...
/*    public Loader<List<Movie>> onCreateLoader(int i, Bundle bundle) {
    ...
    private LoaderCallbacks<List<Movie>>SortByPopular= new LoaderCallbacks<List<Movie>>() {
    @Override
    ...
    private LoaderCallbacks<List<Movie>> SortByUserRating = new LoaderCallbacks<List<Movie>>() {
        @Override
        public Loader<List<Movie>> onCreateLoader(int id, Bundle args) {
            MovieLoader movieLoader =new MovieLoader(this,TMDB_USER_RATING);
